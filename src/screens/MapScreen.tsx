...
// import * as Location from "expo-location"; // Або використовуйте інші способи отримання локації
// import { GlobalStyles } from "../constants";
// import { locations } from "../constants/locations";
// import { LocationData, Region } from "../types/mapTypes";
...
//   const [highlightedLocations, setHighlightedLocations] = useState<LocationData[]>([]);
...
//       });
//     } else {
//       alert("Unable to find current location or selected destination.");
//     }
//   };
...
//         zoom={15}
//         style={GlobalStyles.map}
//         whenCreated={(map) => map.setView([region.latitude, region.longitude], 15)}
//       >
//         <TileLayer
